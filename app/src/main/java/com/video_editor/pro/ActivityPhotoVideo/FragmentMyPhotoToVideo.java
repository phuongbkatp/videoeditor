...
public class FragmentMyPhotoToVideo extends Fragment {
    AdapterMyPhotoToVideo adapterMyPhotoToVideo;
    ...
    private class a extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPreExecute() {
            this.progressDialog = new ProgressDialog(FragmentMyPhotoToVideo.this.getActivity());
        ...
        public Boolean doInBackground(Void... voidArr) {
            return Boolean.valueOf(FragmentMyPhotoToVideo.this.b());
        }
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                FragmentMyPhotoToVideo.this.adapterMyPhotoToVideo = new AdapterMyPhotoToVideo(FragmentMyPhotoToVideo.this.getActivity(), FragmentMyPhotoToVideo.this.videoData, FragmentMyPhotoToVideo.this.imageLoader);
                FragmentMyPhotoToVideo.this.listView.setAdapter(FragmentMyPhotoToVideo.this.adapterMyPhotoToVideo);
            }
        }
    }
