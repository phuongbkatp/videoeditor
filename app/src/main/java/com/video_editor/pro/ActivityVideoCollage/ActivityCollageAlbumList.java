...
public class ActivityCollageAlbumList extends AppCompatActivity {
    static final boolean BOOLEAN = true;
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private int[] ints = {R.mipmap.icon_collage, R.mipmap.icon_myalbum};
    ...
    private void a(ViewPager viewPager) {
        ...
        aVar.a(new FragmentSelectCollage(), "COLLAGE");
        aVar.a(new FragmentMyAlbum(), "MY ALBUM");
