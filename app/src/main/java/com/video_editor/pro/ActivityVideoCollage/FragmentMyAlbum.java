...
public class FragmentMyAlbum extends Fragment {
    AdapterMyAlbum adapterMyAlbum;
    ...
    private class a extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPreExecute() {
            this.progressDialog = new ProgressDialog(FragmentMyAlbum.this.getActivity());
        ...
        public Boolean doInBackground(Void... voidArr) {
            return Boolean.valueOf(FragmentMyAlbum.this.b());
        }
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                FragmentMyAlbum.this.adapterMyAlbum = new AdapterMyAlbum(FragmentMyAlbum.this.getActivity(), FragmentMyAlbum.this.videoData, FragmentMyAlbum.this.imageLoader);
                FragmentMyAlbum.this.listView.setAdapter(FragmentMyAlbum.this.adapterMyAlbum);
            }
        }
    }
